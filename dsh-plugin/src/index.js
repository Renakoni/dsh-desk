...
export { allowGitHostedBuild, blockedBuildPackage, commandError, detectThemeCompatibility, isGitSubdirectoryTarget, mountAppearanceManager, repairKnownThemeDependencies, runPlugin } from './appearance-manager.js'

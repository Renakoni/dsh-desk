...
import { canRevealDshSkillPath, scanDshSkills } from "../src/main/dshSkillCatalog";
...
describe("DSH skill inventory", () => {
  it("matches user-root precedence and invocation frontmatter", () => {
    ...
    expect(snapshot.skills).toEqual([
      expect.objectContaining({ name: "flat-skill", source: "user-agents", active: true, userInvocable: false }),
